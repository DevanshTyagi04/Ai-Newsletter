...
export default function SelectPage() {
    ...
    async function handleSavePrefrences(e: React.FormEvent){
        e.preventDefault();
            ...
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-8">
                    ...
                    <p className="text-xl text-gray-600">
                        Select your interests and delivery frequency to start recieving personalized newsletters
                    </p>
                </div>
                <form onSubmit={handleSavePrefrences}>
                    {/* Category */}
                    <div>
